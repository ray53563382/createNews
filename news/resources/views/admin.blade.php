...
<body class="animsition">
    ...
    <script src="{{ asset('css/slick/slick.min.js') }} ">
    </script>
    <script src="{{ asset('css/wow/wow.min.js') }} "></script>

    <script src="{{ asset('css/animsition/animsition.min.js') }}   "></script>
    <script src="{{ asset('css/bootstrap-progressbar/bootstrap-progressbar.min.js') }}   ">
    </script>
    <script src="{{ asset('css/counter-up/jquery.waypoints.min.js') }}"></script>
    <script src="{{ asset('css/counter-up/jquery.counterup.min.js') }}  ">
    </script>
    <script src="{{ asset('css/circle-progress/circle-progress.min.js') }} "></script>
    <script src="{{ asset('css/perfect-scrollbar/perfect-scrollbar.js') }}  "></script>
    <script src="{{ asset('css/chartjs/Chart.bundle.min.js') }}  "></script>
    <script src="{{ asset('css/select2/select2.min.js') }}  "> -->
    </script>  
