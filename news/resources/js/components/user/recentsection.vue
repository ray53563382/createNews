				...
				<div class="col-md-12 col-lg-8">
					...
					<div class="row">
						...
						<div class="col-sm-6">
							...
							<h4 class="pt-20"><a href="#"><b>{{recientes[0].titulo}}</b></a></h4>
					...
					<div class="row">
						...
						<div class="col-sm-6">
							...
							<ul class="list-li-mr-20 pt-10 mb-30">
								...
								{{recientes[10].fecha}}</li>
							</ul>
						</div><!-- col-sm-6 -->
						
					</div><!-- row -->
					
					<a class="dplay-block btn-brdr-primary mt-20 mb-md-50" href="/search/get_all_docs" ><b>Ver más publicaciones.</b></a>
				</div><!-- col-md-9 -->
				...
				<div class="col-md-6 col-lg-4">
					<div class="pl-20 pl-md-0">
						...
						<div class="mtb-50">
							...
							<a class="oflow-hidden pos-relative mb-20 dplay-block" href="#">
								<div class="wh-100x abs-tlr"><img :src="recientes[11].imgdesmostrativa"  alt=""></div>
								<div class="ml-120 min-h-100x">
									<h5><b>Bitcoin Billionares Hidding in Plain Sight</b></h5>
									<h6 class="color-lite-black pt-10">Por <span class="color-black"><b>{{recientes[11].autor}},</b></span> {{recientes[11].fecha}}</h6>
								</div>
							</a><!-- oflow-hidden -->
