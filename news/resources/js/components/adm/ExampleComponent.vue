                ...
                <div class="sidebar-wrapper">
                    ...
                    <ul class="nav">
                        <li>
                            <a
                                class="nav-link"
                                v-on:click="changeData('publicaciones')"
                            >
                                <i
                                    class="far fa-save"
                        ...
                        <li>
                            <a
                                class="nav-link"
                                v-on:click="changeData('documentos')"
                            >
                                <i
                        ...
                        <li>
                            <a
                                class="nav-link"
                                v-on:click="changeData('editnoticias')"
                            >
                                <i
