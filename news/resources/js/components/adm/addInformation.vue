    ...
    export default {
        data() {
          return {
            ...
            registros: [],
            errors: [],
            registro: {titulo:'',fecha:'', autor:'', importancia:'' ,idcategoria:'',informacionArt:'',imgdesmostrativa:'', id:''}
          }
        },
        created(){
        ...
        methods:{
          eliminar(item,index){
              ...
              confirmButtonText: 'Borrar!'
                  ...
                  if (result.value) {
                    ...
                    // this.evaluacionesService.deletePregunta(bancoPregunta).subscribe(response => {
                    //   if (response.respuesta == true) {
                    //     Swal({
                    //       type: 'success',
                    //       title: 'Pregunta eliminada',
                    //       text: 'Borrado realizado!',
                    //     })
                    //     this.ngOnInit();
                    //   } else {
                    //     Swal({
          ...
          editarData(){
            const params = {titulo: this.registro.titulo, fecha: this.registro.fecha, autor: this.registro.autor, importancia: this.registro.importancia,
            idcategoria: this.registro.idcategoria,informacionArt:  this.registro.informacionArt,  imgdesmostrativa: this.registro.imgdesmostrativa };
