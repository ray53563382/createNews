                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 pr-1">
                                    <div class="form-group">
                                        ...
                                        <select
                                            class="form-control"
                                            v-model="registro.importancia"
                                        >
                                            <!-- <option selected>Selecciona</option> -->
                                            <option value="1"
                                                >Alta importancia</option
                                            >
                                            <option value="2"
                                                >Media importancia</option
                                            >
                                            <option value="3"
                                                >Baja importancia</option
                                            >
                                        </select>
                                    </div>
                                </div>
                ...
                <div class="card card-user">
                    ...
                    <div class="card-body">
                        ...
                        <p class="description text-center">
                            ...
                            <br />
                            Valida que tus datos esten correctos para el
                            correcto guardado <br />
                            Despues de guardar valida tus cambios en tu página
                            web
                        </p>
                    </div>
                    <hr />
